                  ...
                  return (
                    <li key={m._id} className="px-5 py-4 bg-gray-50/60">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <input
                          type="number" min={0} value={prevScoreA}
                        ...
                        <input
                          type="number" min={0} value={prevScoreB}
                ...
                return (
                  <li key={m._id} className="px-5 py-3 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0 flex items-baseline gap-1.5 text-sm">
                      <span className={`truncate font-medium ${aWon ? "text-blue-700" : isDraw ? "text-gray-500" : "text-gray-400"}`}>
                        <Link href={`/players/${m.playerAId}/innerwar?innerwar=${innerwarId}`} className="hover:underline">
                          {displayName(m.playerA)}
                        </Link>
                        <WinBadge wins={m.playerA?.leagueWins} />
                      ...
                      <span className="text-xs text-gray-300 shrink-0">vs</span>
                      <span className={`truncate font-medium ${bWon ? "text-red-700" : isDraw ? "text-gray-500" : "text-gray-400"}`}>
                        <Link href={`/players/${m.playerBId}/innerwar?innerwar=${innerwarId}`} className="hover:underline">
                          {displayName(m.playerB)}
                        </Link>
                        <WinBadge wins={m.playerB?.leagueWins} />
                    ...
                    <span className="text-sm font-bold text-gray-900 shrink-0">{m.scoreA} : {m.scoreB}</span>
                    <div className="flex items-center gap-1 shrink-0">
                      {aWon ? (
                        <span className="text-xs font-bold text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded">A승</span>
                      ) : bWon ? (
                        <span className="text-xs font-bold text-red-600 bg-red-50 px-1.5 py-0.5 rounded">B승</span>
                      ) : (
